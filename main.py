...
fig2, axes = plt.subplots(nrows=3, ncols=2, figsize=(12, 15))
...
axes[1].set(title="c) Savintzky-Golay filters and moving avg with window 3", xlabel="x",ylabel="y")
axes[1].add_patch(rect2)
axes[1].legend()

axes[2].plot(df['left wrist x raw'], df['left wrist y raw'], label="raw data")
axes[2].plot(df['left wrist x (3)'], df['left wrist y (3)'], label="MA, window of 3")
axes[2].plot(df['left wrist x (10)'], df['left wrist y (10)'], label="MA, window of 10")
axes[2].plot(df['left wrist x (30)'], df['left wrist y (30)'], label="MA, window of 30")
axes[2].set(title="d) Zoomed in moving average filters", xlabel="x",ylabel="y")
...
axes[3].set(title="f) Zoomed in on Savintzky-Golay filters", xlabel="x",ylabel="y")
...
axes[4].set(title="b) Moving average filter over time", xlabel="time [s]",ylabel="x coordinate")
